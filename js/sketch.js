...
var options ={  
  ...
  Random: function () { 
          ...
          noiseControl.setValue(options.noiseScale);
          LengthControl.setValue(options.Length);
          NumsControl.setValue(options.Nums);
          RMaxControl.setValue(options.MaxRadius);
          RMinControl.setValue(options.MinRadius);
          shapeControl.setValue(options.ColorMode);
        },
}
